...
public class AnnotationServletV3 implements HttpServlet {
    ...
    public AnnotationServletV3(List<Object> controllers) {
        this.pathMap = new HashMap<String, ControllerMethod>();
        ...
        for (Object controller : controllers) {
            ...
            for (Method method : methods) {
                if (method.isAnnotationPresent(Mapping.class)) {
                    ...
                    this.pathMap.put(path, new ControllerMethod(controller, method));
                }
            }
        ...
        public void invoke(HttpRequest request, HttpResponse response) {
            ...
            for (int i = 0; i < parameterTypes.length; i++) {
                if (parameterTypes[i] == HttpRequest.class) {
                    ...
                    throw new IllegalArgumentException("parameter " + parameterTypes[i].getName() + " is not supported");
                }
            }
