...
public class EncodingMain2 {
    ...
    public static void main(String[] args) {
        ...
        test("A", US_ASCII, UTF_16BE); // ASCII 실패

        System.out.println("== 한글  인코딩  - 기본 ==");
        test("가", US_ASCII, US_ASCII); // ASCII 실패
        test("가", ISO_8859_1, ISO_8859_1); // ASCII 실패
        test("가", EUC_KR, EUC_KR); // ASCII 실패
        test("가", MS_949, MS_949); // ASCII 실패
        test("가", UTF_8, UTF_8); // ASCII 실패
        test("가", UTF_16, UTF_16); // ASCII 실패
